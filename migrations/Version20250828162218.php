 ...
 */
final class Version20250828162218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE address (id SERIAL NOT NULL, customer_id INT NOT NULL, city VARCHAR(255) NOT NULL, postcode VARCHAR(255) NOT NULL, street_adress VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
