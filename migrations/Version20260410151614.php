 ...
 */
final class Version20260410151614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX idx_1b226841962f8178');
        $this->addSql('ALTER TABLE bag RENAME COLUMN road_id TO road_part_id_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bag RENAME COLUMN road_part_id_id TO road_id');
        $this->addSql('ALTER TABLE bag ADD CONSTRAINT fk_1b226841962f8178 FOREIGN KEY (road_id) REFERENCES road (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
